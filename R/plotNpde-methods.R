  ...
  for(ipl in plot.type) {
    switch (EXPR=ipl,
            ...
            "x.scatter"={
              ...
              npde.plot.meanprofile(x,xaxis="x",new=force.new,...)
              #     	if(xscale) {
              #     		npde.plot.meanprofile(x,xaxis="x",new=force.new,...)
              #     	} else npde.plot.scatter(x,xaxis="x",new=force.new,...)
            },
            "pred.scatter"={
            ...
            "cov.scatter"={
              ...
              npde.plot.meanprofile(x,xaxis="cov",new=force.new,...)
            },
            "qqplot"={
            ...
            "vpc"={
              ...
              npde.plot.meanprofile(x,which="yobs",new=force.new,...)
              #     	ich<-0
