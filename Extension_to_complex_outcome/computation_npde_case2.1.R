...
data_L = fread("Case_2.1/data_L.txt",na.strings = ".")
sim_L = fread("Case_2.1/sim_L.txt",na.strings = ".")



data_TTE = fread("Case_2.1/data_TTE.txt",na.strings = ".")
sim_TTE = fread("Case_2.1/sim_TTE.txt",na.strings = ".")
